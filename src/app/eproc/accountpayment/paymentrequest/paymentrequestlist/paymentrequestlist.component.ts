...
export class PaymentRequestlistComponent extends BaseComponent implements OnInit {
  ...
  private RoleAccessCode = 'R00021640000000A'; // role access 
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/accountpayable/subpaymentrequestlist/paymentrequestdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/accountpayable/subpaymentrequestlist/paymentrequestdetail', codeEdit]);
  }
