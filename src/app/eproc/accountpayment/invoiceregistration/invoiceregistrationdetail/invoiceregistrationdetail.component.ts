...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './invoiceregistrationdetail.component.html'
})

export class InvoiceRegistrationdetailComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  ngOnInit() {
    ...
    this.callGlobalParamForThirdPartyVendorBank();
    if (this.param != null) {
      ...
      this.model.invoice_amount = 0;
      this.model.shipping_fee = 0;
      this.model.pph = 0;
      this.model.ppn = 0;
      this.model.discount = 0;
      this.model.bill_type = "PO";
    }
  }
  ...
  btnBack() {
    ...
    this.route.navigate(['/accountpayable/subinvoiceregisterlist']);
  }
