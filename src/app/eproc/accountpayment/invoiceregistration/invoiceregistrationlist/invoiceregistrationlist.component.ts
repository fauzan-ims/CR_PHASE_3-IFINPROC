...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './invoiceregistrationlist.component.html'
})

export class InvoiceRegistrationlistComponent extends BaseComponent implements OnInit {
  // variable
  public listInvoiceRegistration: any = [];
  ...
  private RoleAccessCode = 'R00021610000000A'; // role access 
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listInvoiceRegistration = parse.data;
          if (parse.data != null) {
            this.listInvoiceRegistration.numberIndex = dtParameters.start;
          }
  ...
  // btnDeleteAll() {
  //   this.checkedList = [];
  //   for (let i = 0; i < this.listInvoiceRegistration.length; i++) {
  //     if (this.listInvoiceRegistration[i].selected) {
  //       this.checkedList.push(this.listInvoiceRegistration[i].code);
  //     }
  //   }
  ...
  //                 $('#datatableInvoiceRegistration').DataTable().ajax.reload();
  //               } else {
  ...
  // selectAllTable() {
  //   for (let i = 0; i < this.listInvoiceRegistration.length; i++) {
  //     this.listInvoiceRegistration[i].selected = this.selectedAllTable;
  //   }
  // }

  // checkIfAllTableSelected() {
  //   this.selectedAllTable = this.listInvoiceRegistration.every(function (item: any) {
