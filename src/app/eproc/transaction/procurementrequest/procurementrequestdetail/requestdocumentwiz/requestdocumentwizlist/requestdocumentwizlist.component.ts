...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './requestdocumentwizlist.component.html'
})

export class RequestdocumentwizComponent extends BaseComponent implements OnInit {
  // get param from url
