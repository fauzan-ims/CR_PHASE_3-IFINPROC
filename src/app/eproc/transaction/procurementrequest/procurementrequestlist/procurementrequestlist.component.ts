...
export class ProcurementrequestlistComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/transaction/subprocurementrequest/procurementrequestdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/transaction/subprocurementrequest/procurementrequestdetail', codeEdit]);
  }
  ...
  selectAllTable() {
    for (let i = 0; i < this.listprocurementrequest.length; i++) {
      if(this.listprocurementrequest[i].status !== 'POST'){
