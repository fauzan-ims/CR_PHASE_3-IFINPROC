...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './finalgoodreceiptnotelist.component.html'
})

export class FinalGoodReceiptNotelistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  private RoleAccessCode = 'R00024020000001A'; // role access 
...
//#endregion load all data
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/transaction/subfinalgoodreceiptnote/finalgoodreceiptnotedetail', codeEdit]);
  }
