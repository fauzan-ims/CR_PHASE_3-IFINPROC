...
export class GoodReceiptNotelistComponent extends BaseComponent implements OnInit {
  // variable
  ...
  private RoleAccessCode = 'R00021590000000A'; // role access 
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/transaction/subgoodreceiptnotelist/goodreceiptnotedetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/transaction/subgoodreceiptnotelist/goodreceiptnotedetail', codeEdit]);
  }
