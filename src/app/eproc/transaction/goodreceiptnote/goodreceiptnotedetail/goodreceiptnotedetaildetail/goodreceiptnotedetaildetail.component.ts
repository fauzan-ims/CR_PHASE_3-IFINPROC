...
export class GoodReceiptNoteDetaildetailComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  btnBack() {
    ...
    this.route.navigate(['/transaction/subgoodreceiptnotelist/goodreceiptnotedetail', this.param]);
  }
  ...
  btnSelectRowTax(code: String, description: String, ppn_pct: String, pph_pct: String) {
    ...
    // this.model.ppn_amount = this.model.price_amount * (100 / (this.model.ppn_pct * 1))
    // this.model.pph_amount = this.model.price_amount * (100 / (this.model.pph_pct * 1))
