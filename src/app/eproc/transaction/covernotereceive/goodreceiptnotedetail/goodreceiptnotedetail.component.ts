...
export class CoverNoteReceivedetailComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIRouteForProceed: String = 'ExecSpForCoverNotePost';
  ...
  private APIRouteGetRows: String = 'GetRowsForCoverNote';
  ...
  btnBack() {
    ...
    this.route.navigate(['/transaction/subdocumentreceivelist']);
  }
  //#endregion button back

  //#region button add
  btnAdd() {
    this.route.navigate(['/transaction/subdocumentreceivelist/covernotedetaildetail', this.param]);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/transaction/subdocumentreceivelist/covernotedetaildetail', this.param, codeEdit]);
  }
