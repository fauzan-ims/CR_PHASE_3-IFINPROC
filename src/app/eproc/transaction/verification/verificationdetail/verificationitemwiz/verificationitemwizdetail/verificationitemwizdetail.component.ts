...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './verificationitemwizdetail.component.html'
})

export class VerificationitemwizdetailComponent extends BaseComponent implements OnInit {
  // get param from url
        ...
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              ...
              this.showNotification('top', 'right', 'success');
               this.route.navigate(['/transaction/subverification/verificationitemwizdetail/' + this.param + '/verificationitemwizdetail', this.param, parse.id], { skipLocationChange: true });
              } else {
              this.swalPopUpMsg(parse.data);
            }
          },
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/transaction/subverification/verificationitemwizdetail/' + this.param + '/verificationitemwizlist', this.param], { skipLocationChange: true });
