...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './quotationreviewdocumentwizlist.component.html'
})

export class QuotationReviewDocumentWizListComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIController: String = 'QuotationReviewDocument';
