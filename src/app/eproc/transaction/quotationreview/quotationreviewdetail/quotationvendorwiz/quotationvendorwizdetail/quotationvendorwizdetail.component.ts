...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './quotationvendorwizdetail.component.html'
})

export class QuotationReviewVendorWizDetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    private APIRouteForLookupForQuotation: String = 'GetRowsForLookup';
        ...
        this.dalservice.Getrow(this.dataTamp, this.APIController, this.APIRouteForGetRow)
            .subscribe(
                res => {
                    ...
                    this.nett_price = parsedata.nett_price * 1;
                    this.discount_amount = parsedata.discount_amount * 1;
                    this.unit_price = parsedata.price_amount * 1;
                    // mapper dbtoui
            ...
            this.dalservice.Insert(usersJson, this.APIController, this.APIRouteForInsert)
                .subscribe(
                    res => {
                        ...
                        if (parse.result === 1) {
                            this.showNotification('bottom', 'right', 'success');
                            this.route.navigate(['/transaction/subquotationreviewlist/quotationreviewdetail/' + this.param + '/quotationvendorwizdetail', this.param, parse.id]);
                        } else {
                            this.swalPopUpMsg(parse.data);
                        }
                    },
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/transaction/subquotationreviewlist/quotationreviewdetail/' + this.param + '/quotationvendorwizlist', this.param]);
    ...
    btnSelectRowTax(code: String, description: String, ppn_pct: String, pph_pct: String) {
        // this.temp_price = (((100 / ((this.model.tax_pph_pct * 1) - (this.model.tax_ppn_pct) + 100)) * (this.nett_price * 1)) + (this.discount_amount * 1))
        this.model.tax_code = code;
        this.model.tax_name = description;
        this.model.tax_pph_pct = pph_pct;
        this.model.tax_ppn_pct = ppn_pct;
        this.nett_price = Math.round(this.unit_price - this.discount_amount + ((this.unit_price - this.discount_amount) * (this.model.tax_ppn_pct / 100)) - ((this.unit_price - this.discount_amount) * (this.model.tax_pph_pct / 100)));
        this.model.nett_price = this.nett_price;
    ...
    //     this.model.nett_price = Math.round(this.unit_price * 1) - (this.discount_amount * 1) + (((this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.tax_ppn_pct * 1 / 100)) - (((this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.tax_pph_pct * 1 / 100));
    // }
    //#endregion unitprice

    //#region unitprice
    UnitPrice(event: any) {       
        this.unit_price = event.target.value * 1;
        this.model.price_amount = this.unit_price;
        this.nett_price = Math.round(this.unit_price - this.discount_amount + ((this.unit_price - this.discount_amount) * (this.model.tax_ppn_pct / 100)) - ((this.unit_price - this.discount_amount) * (this.model.tax_pph_pct / 100)));
        this.model.nett_price = this.nett_price;
    }
    //#endregion unitprice
    ...
    //     // this.model.nett_price = (this.unit_price * 1) - (this.discount_amount * 1) + (((this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.ppn_pct * 1 / 100)) - (((this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.pph_pct * 1 / 100));
    //     this.model.nett_price = (this.model.price_amount || this.unit_price * 1) - (this.discount_amount * 1) + (((this.model.price_amount || this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.tax_ppn_pct * 1 / 100)) - (((this.model.price_amount || this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.tax_pph_pct * 1 / 100));
    // }
    //#endregion Discount

    //#region Discount
    DiscountAmount(event: any) {
        this.discount_amount = event.target.value * 1;
        this.model.discount_amount = this.discount_amount;
        this.nett_price = (this.model.price_amount || this.unit_price) - (this.discount_amount) + (((this.model.price_amount || this.unit_price) - (this.discount_amount)) * (this.model.tax_ppn_pct / 100)) - (((this.model.price_amount || this.unit_price) - (this.discount_amount)) * (this.model.tax_pph_pct / 100));
        this.model.nett_price = this.nett_price;
    }
    //#endregion Discount
    ...
    //     this.model.price_amount = Math.round((((100 / ((this.model.tax_ppn_pct * 1) - (this.model.tax_pph_pct) + 100)) * (this.nett_price * 1)) + (this.discount_amount * 1)))
    // }
    //#endregion NettPrice
    ...
    NettPrice(event: any) {
        this.nett_price = event.target.value * 1;
        this.model.nett_price = this.nett_price;
        this.nett_price = Math.round((((100 / (this.model.tax_ppn_pct - (this.model.tax_pph_pct) + 100)) * this.nett_price) + this.discount_amount))
        this.model.price_amount = this.nett_price
    }
    //#endregion NettPrice
}
