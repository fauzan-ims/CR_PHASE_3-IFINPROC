...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './quotationreviewdetailwizlist.component.html'
})

export class QuotationReviewDetailWizListComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/transaction/subquotationreviewlist/quotationreviewdetail/' + this.param + '/quotationreviewdetailwizdetail', this.param, codeEdit], { skipLocationChange: true });
  }
