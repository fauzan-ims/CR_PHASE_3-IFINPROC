...
@Component({
    moduleId: module.id,
    selector: 'app-root',
    templateUrl: './quotationvendor.component.html'
})

export class QuotationVendorApprovalDetailComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    //#region button back
    btnBack() {
        this.route.navigate(['/objectinfosupplierselection/supplierselectionapproval', this.param]);
