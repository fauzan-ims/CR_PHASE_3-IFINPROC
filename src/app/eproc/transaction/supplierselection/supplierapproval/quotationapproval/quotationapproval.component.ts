...
export class QuotationApprovalComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    UnitPrice(event: any) {
        ...
        // this.model.nett_price = (this.unit_price * 1) - (this.discount_amount * 1)
        // this.model.nett_price = (((this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.ppn_pct * 1 / 100))
    ...
    DiscountAmount(event: any) {
        ...
        // this.model.nett_price = (this.unit_price * 1) - (this.discount_amount * 1) + (((this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.ppn_pct * 1 / 100)) - (((this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.pph_pct * 1 / 100));
        this.model.price_amount = (((100 / ((this.model.ppn_pct * 1) + 100)) * (this.nett_price * 1)) + (this.discount_amount * 1))
        // this.model.price_amount = ((100 / ((this.model.ppn_pct * 1) + 100)) * (this.nett_price * 1)) + (this.discount_amount * 1)
        // this.model.nett_price = ((this.unit_price * 1) - (this.discount_amount * 1) + ((this.unit_price * 1) - (this.discount_amount * 1) * (this.model.ppn_pct * 1 / 100)) - ((this.unit_price * 1) - (this.discount_amount * 1) * (this.model.pph_pct * 1 / 100)));
        // this.model.nett_price = (this.unit_price * 1) - (this.discount_amount * 1)
        // this.model.nett_price = (((this.unit_price * 1) - (this.discount_amount * 1)) * (this.model.ppn_pct * 1 / 100))
