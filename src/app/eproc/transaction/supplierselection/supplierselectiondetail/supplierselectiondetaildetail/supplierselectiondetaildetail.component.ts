...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './supplierselectiondetaildetail.component.html'
})

export class SupplierSelectionDetaildetailComponent extends BaseComponent implements OnInit {
  // get param from url
      ...
      this.dalservice.Insert(usersJson, this.APIController, this.APIRouteForInsert)
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              this.showNotification('bottom', 'right', 'success');
              this.route.navigate(['/transaction/subsupplierselectionlist/supplierselectiondetaildetail', this.param, parse.id]);
            } else {
              this.swalPopUpMsg(parse.data);
            }
          },
  ...
  btnBack() {
    ...
    this.route.navigate(['/transaction/subsupplierselectionlist/supplierselectiondetail', this.param]);
  }
