...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './masterwarehousedetailwizdetail.component.html'
})

export class MasterWarehousedetailwizdetailComponent extends BaseComponent implements OnInit {
  // get param from url
  ...
  private APIControllerBaseItemCode: String = 'MasterWarehouse'; 
        ...
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              ...
              this.showNotification('top', 'right', 'success');
               this.route.navigate(['/systemsetting/submasterwarehouselist/masterwarehousedetail/' + this.param + '/masterwarehousedetailwizdetail', this.param, parse.id], { skipLocationChange: true });
              } else {
              this.swalPopUpMsg(parse.data);
            }
          },
