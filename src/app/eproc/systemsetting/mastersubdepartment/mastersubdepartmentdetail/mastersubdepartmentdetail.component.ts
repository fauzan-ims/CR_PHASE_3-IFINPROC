...
@Component({
  selector: 'app-root',
  templateUrl: './mastersubdepartmentdetail.component.html'
})
export class MastersubdepartmentdetailComponent extends BaseComponent implements OnInit {
  // get param from url
        ...
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              this.showSpinner = false;
              this.showNotification('bottom', 'right', 'success');
              this.route.navigate(['/systemsetting/submastersubdepartment/mastersubdepartmentdetail', parse.code]);
            } else {
              this.showSpinner = false;
              this.swalPopUpMsg(parse.data)
            }
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/systemsetting/submastersubdepartment']);
